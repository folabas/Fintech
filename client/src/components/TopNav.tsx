        ...
        <div className="top-nav-inner">
          ...
          {user ? (
            <div className="nav-actions">
              <button className="mobile-menu-btn" onClick={() => setMenuOpen(true)} title="Menu">
          ...
          <div className="mobile-drawer" onClick={e => e.stopPropagation()}>
            <div className="mobile-drawer-header">
              <div className="mobile-drawer-user">
                ...
                <div>
                  <div className="mobile-drawer-name">{user?.fullName}</div>
                  <div className="mobile-drawer-id">{user?.accountId}</div>
                </div>
              </div>
